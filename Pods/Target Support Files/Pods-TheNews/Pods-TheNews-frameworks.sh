...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "$BUILT_PRODUCTS_DIR/Heimdallr/Heimdallr.framework"
  install_framework "$BUILT_PRODUCTS_DIR/JTHamburgerButton/JTHamburgerButton.framework"
  install_framework "$BUILT_PRODUCTS_DIR/Moya/Moya.framework"
  install_framework "$BUILT_PRODUCTS_DIR/Result/Result.framework"
  install_framework "${PODS_ROOT}/Reveal-SDK/RevealServer-5/iOS/RevealServer.framework"
  install_framework "$BUILT_PRODUCTS_DIR/SwiftyJSON/SwiftyJSON.framework"
  install_framework "$BUILT_PRODUCTS_DIR/libHN/libHN.framework"
